...
resource "aws_lambda_function" "user_weights_get_lambda_function" {
  function_name    = "user_weights_get_lambda"
...
output "user_weights_get_lambda_ARN" {
    value = aws_lambda_function.user_weights_get_lambda_function.arn
}

output "user_weights_get_lambda_Invoke_ARN" {
  value = aws_lambda_function.user_weights_get_lambda_function.invoke_arn
}